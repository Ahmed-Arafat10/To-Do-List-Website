...
<body>
        ...
        ?>
            <tr>
                ...
                <?php if ($FetchData['isdone'] == 1) : ?>
                    <td><del><?php echo  $FetchData['Note'] ?></del></td>
                <?php else : ?>
                    <td><?php echo  $FetchData['Note'] ?></td>
                <?php endif; ?>
                <td><a href="./index.php?UpdateState=<?php echo $FetchData['id'] ?>"><img src="Pic/Done.png" height="40" width="40" alt=""></a></td>
                <td><a href="./index.php?Delete=<?php echo $FetchData['id'] ?>"><img src="Pic/Delete.png" height="40" width="40" alt=""></a></td>
            </tr>
        <?php } ?>
    </table>
    <!-- Table Tag End -->
    ...
    <div class="Me-Container">
        <p style="text-align: justify;" class="Me-Par">Peter Quill : [Pointing guns at Stark and Parker] Everybody stay where you are, chill the eff out!
            [to Iron Man]
        ...
        <div class="CARD">
            <div class="front">
                ...
                <p>Hello there, I'm Ahmed Arafat .. I'm C++ Developer Who Loves Technology & Computer .. I'm Currently An
                    Instructor At ICPC FCI-HU Community, I'm Learning Web Development + Designing, It's Really So Funny & Totally Easier Than Problem Solving & Algorithms !</p>
                <span>Hover Me</span>
            </div>
            <div class="back">
                <ul>
